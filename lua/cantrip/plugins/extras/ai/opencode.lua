...
return {
  ...
  --   end,
  --   keys = {
  --     -- { "n", "x" }, "<C-x>", function() require("opencode").select() end,                          { desc = "Execute opencode action…" })
  --     --
  --     -- { "n", "x" }, "go",  function() return require("opencode").operator("@this ") end,        { desc = "Add range to opencode", expr = true })
  --     -- "n",          "goo", function() return require("opencode").operator("@this ") .. "_" end, { desc = "Add line to opencode", expr = true })
  ...
  --       "<leader>as",
  --       function()
  --         require("opencode").operator("@visible ")
  --       end,
  --       mode = "v",
  --       desc = "Send to Opencode",
  --     },
